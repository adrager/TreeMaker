...
def getWeightProducer(fileName):
   ...
   ## Spring15
   if "TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8" in fileName and "Asympt25ns" in fileName:
      mcVersion = "DR74"
      weightProducer.Method     = cms.string("Constant")
      weightProducer.XS         = cms.double(806.1)
      weightProducer.NumberEvts = cms.double(11339232)
      print "TTJets_TuneCUETP8M1_13TeV-madgraphMLM-pythia8 : '"+fileName+"'"
      applyWeight = True
      weightProducer.weight = cms.double(-1.)
