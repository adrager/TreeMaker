 ...
 #       ),
    ...
    Efficiencies = cms.PSet(
      ...
      ElecIsoActivityPt = cms.PSet(
       ...
       Activity = cms.vdouble(1,20,40,60,150,1600 ),
      ),
      BinToPDFmap = cms.vstring("vpvPlusExpo")
    ),
      ElecIsoHT = cms.PSet(
       ...
       UnbinnedVariables = cms.vstring("InvariantMass"),
       BinnedVariables = cms.PSet(
       HT = cms.vdouble(350,500,550,600,650,700,750,800,900,1000,1200,1500,2000,8000 ),
      ),
      BinToPDFmap = cms.vstring("vpvPlusExpo")
    ),  
      ElecIsoNJets = cms.PSet(
       EfficiencyCategoryAndState = cms.vstring("Pass","pass"),
       UnbinnedVariables = cms.vstring("InvariantMass"),
       BinnedVariables = cms.PSet(
       NJets = cms.vdouble(4,5,6,8,11,20 ),
      ),
      BinToPDFmap = cms.vstring("vpvPlusExpo")
    ),
      #ElecIsoPt = cms.PSet(
