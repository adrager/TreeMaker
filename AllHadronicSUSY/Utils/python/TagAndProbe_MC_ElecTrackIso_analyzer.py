...
Pt = cms.vdouble(1,200),
Activity = cms.vdouble(1,1600),
)
## for super clusters
...
Pt = cms.vstring("p_{T}", "5", "200", "GeV/c"),
...
"CBExGaussShape::signalResPass(InvariantMass, meanP[0.], sigmaP[8.5695e-04, 0., 3.],alphaP[3.8296e-04], nP[6.7489e+00], sigmaP_2[2.5849e+00], fracP[6.5704e-01])",  ### signal resolution for "pass" sample
"CBExGaussShape::signalResFail(InvariantMass, meanF[2.0946e-01, -5., 5.], sigmaF[8.5695e-04, 0., 5.],alphaF[3.8296e-04], nF[6.7489e+00], sigmaF_2[2.5849e+00], fracF[6.5704e-01])",  ### signal resolution for "fail" sample     
#"ZGeneratorLineShape::signalPhy(InvariantMass)", ### NLO line shape removed cant fined file ZeeGenLevel.root
"Voigtian::ZPeak(InvariantMass, mean[91.2, 84.0, 98.0], width[2.4, 0.5, 5.0], sigma[5., 1., 12.0])",
"RooCMSShape::backgroundPass(InvariantMass, alphaPass[60.,50.,70.], betaPass[0.001, 0.,0.1], betaPass, peakPass[90.0])",
"RooCMSShape::backgroundFail(InvariantMass, alphaFail[60.,50.,70.], betaFail[0.001, 0.,0.1], betaFail, peakFail[90.0])",
"FCONV::signalPass(InvariantMass, ZPeak, signalResPass)",
"FCONV::signalFail(InvariantMass, ZPeak, signalResFail)",     
"efficiency[0.9,0,1]",
...
"Voigtian::signal1(InvariantMass, mean1[90,80,100], width[2.495], sigma1[2,1,3])",
"Voigtian::signal2(InvariantMass, mean2[90,80,100], width,        sigma2[4,2,10])",
"SUM::signal(vFrac[0.8,0,1]*signal1, signal2)",
"Exponential::backgroundPass(InvariantMass, lp[-0.1,-1,0.1])",
"Exponential::backgroundFail(InvariantMass, lf[-0.1,-1,0.1])",
"efficiency[0.9,0,1]",
"signalFractionInPassing[0.9]"
)
#        pdfSignalPlusBackground = cms.vstring(
...
#Pt = cms.vdouble( 5,20,30,50,200 ),
Pt = cms.vdouble( 5,10,20,25,30,40,50,200 ),
Activity = cms.vdouble(1,20,60,150,1600 ),
#Pt = cms.vdouble( 5,30,200 ),
#Activity = cms.vdouble(0,60,1600 ),
),
#BinToPDFmap = cms.vstring("gaussPlusCubic") standard
#BinToPDFmap = cms.vstring("gaussPlusCMS") # bad backgournd did not converge flat background distribution
#BinToPDFmap = cms.vstring("pdfSignalPlusBackground") # bad performance
